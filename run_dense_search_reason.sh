...
OUTPUT_NAME=results/r-bert-base-chinese.json

# MODEL_NAME=hfl/chinese-roberta-wwm-ext
# OUTPUT_NAME=results/r-roberta-wwm-ext.json

# MODEL_NAME=cyclone/simcse-chinese-roberta-wwm-ext
# OUTPUT_NAME=results/r-simcse-roberta-wwm-ext.json

# MODEL_NAME=hfl/chinese-bert-wwm
# OUTPUT_NAME=results/r-hfl-bert-wwm.json

# MODEL_NAME=BAAI/bge-large-zh-v1.5
# OUTPUT_NAME=results/r-bge-large-zh-v1.5.json

# MODEL_NAME=CSHaitao/SAILER_zh
# OUTPUT_NAME=results/r-SAILER.json

# MODEL_NAME=thunlp/Lawformer
# OUTPUT_NAME=results/r-Lawformer.json
